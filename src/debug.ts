import "./app";
import { spawnBuster } from "./animation/buster";
...
import { spawnNamed, spawnRandom } from "./animation/spawners";
...
global.randomEmotes = randomEmotes;
